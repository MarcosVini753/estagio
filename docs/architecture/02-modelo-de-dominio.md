...
Constraints exigem uma sessão ativa por referência de usuário, início planejado anterior ao fim e prazo não anterior ao fim planejado. Uso imediato não pode começar antes do início planejado; sessão vinculada a reserva pode começar até três minutos antes dele. O serviço limita o check-in de uma reserva até `check_in_deadline_at`.
