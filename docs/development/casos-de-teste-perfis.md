...
| CT-PERF-07 | Usuário/Monitor ↔ Supervisor/Administrador | Gere dados históricos, consulte Diário, Mensal, Anual e Indicadores e baixe CSV, XLSX e PDF. Repita a chamada JSON e o download com cada perfil. | Supervisor e Administrador recebem projeção completa e arquivos sem referências individuais; Usuário e Monitor recebem `403`. Tela e arquivos apresentam os mesmos totais e ressalvas. | `apps.reports.test_reports`, testes de views do Supervisor e Playwright. |
